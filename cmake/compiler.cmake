...
# Tune according to devices

set(ADDITIONAL_C_FLAGS "${STM32_C_FLAGS}")
set(ADDITIONAL_CXX_FLAGS "${STM32_CXX_FLAGS}")
set(ADDITIONAL_LIBS "${STM32_LIBS}")
set(ADDITIONAL_LINKER_FLAGS "${STM32_LINKER_FLAGS}")
...
set(LINKER_FLAGS "${LINKER_FLAGS} -nostartfiles -lc -lnosys --specs=rdimon.specs ${ADDITIONAL_LIBS}")
set(CMAKE_EXE_LINKER_FLAGS "${LINKER_FLAGS} ${ADDITIONAL_LINKER_FLAGS}")
